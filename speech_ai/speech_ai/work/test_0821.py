...
class Test:
    def test_t(self):
        audio_path = 'E:/django_ai/speech_ai/speech_ai/work/record_wav/0821.wav'
        # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%转文字%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            def gene_request(self, apiname, data, files=None, headers=None):
                ...
                if result["ok"] == 0:
                    if apiname == '/getResult':
                        ...
                        print(results)
                        with open("E:/Pythonfiles/py/AIwords/txt/txt_files/" + "0821.txt", "wt",
        ...
        APP_ID = "b873a516"
        SECRET_KEY = "7487b4a3fbc9af5deae37df1904f5006"
        ...
        api.all_api_request()
        txt_path = "E:/Pythonfiles/py/AIwords/txt/txt_files/" +  "0821.txt"
        ...
        wsParam = Ws_Param(APPID='7959b5ba', APISecret='NzU4NDUxNDk0NzY2MjdhOTBmMzcwODE0',
    ...
    # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%人体姿态评估%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        def med(success, image):
            with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
                ...
                pose = np.array([[res.x, res.y, res.z, res.visibility] for res in results.pose_landmarks.landmark]).flatten() if results.pose_landmarks else np.array(0)
        ...
        input_video = 'E:/django_ai/speech_ai/speech_ai/work/record_wav/0821.mp4' # 输入的视频路径
    ...
    # 标准动作识别时，按任意键进行下一张图片的识别，视频和摄像头时，按 q 键 结束识别
        ...
        primary_key = cur.execute(sql_select) + 1
        a = [x for x in range(1, 101)]
        n = 0
        d = {}
        tree = ET.parse('E:/jupyter/0725.xml')
        root = tree.getroot()  # 找到树根
        for child_1 in root[0][0]:
            d = child_1.attrib  # 将总评分各参数放入字典d
        time_now = datetime.now().strftime("%Y-%m-%d-%H-%M-%S")
        total_score = round(float(d['fluency_score']) * 0.4 + float(d['integrity_score']) * 0.1 + affix_score * 0.2 + float(
        ...
        param = (
            ...
            round(float(d['integrity_score']), 2), round(float(d['phone_score']), 2), round(float(d['tone_score']), 2), 81,
            affix_score, total_score,body_score)
