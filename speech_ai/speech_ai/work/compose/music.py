...
import sys
import shutil
import speech_ai.work.wav_note.music_transcriber
from speech_ai.work.wav_note import music_transcriber
...
class Music:
    ...
    def __init__(self, melody=None, name=name_time + ".wav", program=0, bpm=75, save_path=os.path.join(BASE_DIR, 'compose_mid')):
        self.melody = melody
        self.name = name
    ...
    # 重新设置参数
    # 音乐名
    def set_name(self, name=name_time + ".wav"):
        self.name = name
